...
public class GradientDescentTest {
	...
	public void testExecute() throws Exception {
		...
		Assert.assertEquals(0.7000050560272939, task.execute(new Vector(4.0)).get(0), Math.pow(10, -6));
		Assert.assertEquals(-4.899951616389444, task.execute(new Vector(-10.0)).get(0), Math.pow(10, -6));
	}
}
