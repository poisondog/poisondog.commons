 ...
 * @since 2018-01-24
 */
public class Reply implements Mission<Reply.Parameter> {

	@Override
	public Void execute(Reply.Parameter parameter) throws IOException {
		HttpParameter para = new HttpParameter();
		para.setUrl("https://api.line.me/v2/bot/message/reply");
		...
		relay.put("replyToken", parameter.mReplyToken);
	...
	public static class Parameter {
		...
		private String mReplyToken;
		private List<String> mReplyMessages;

		/**
		 * Constructor
		 */
		public Parameter(String auth, String token) {
			mAuth = auth;
			mReplyToken = token;
		...
		public void addLine(String line) {
			if (mReplyMessages.size() >= 5)
				throw new IllegalArgumentException("reply messages can't over 5.");
